    ...
    return (
        ...
        relative overflow-hidden mx-auto py-10 md:py-0'>
            ...
            <div className='p-4 relative z-10 w-full text-center'>
                ...
                max-w-lg mx-auto'>Drive into our Comprehensive music course and transfer 
                your musical journy tody. Whether you're a beginner or looking to 
                refine your skills, join us to unlock your true potential</p>
