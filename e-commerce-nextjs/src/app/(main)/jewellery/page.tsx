  ...
  return (
    ...
    <>
      ...
      <ul className='flex gap-7 text-xs justify-center p-2 px-8 font-semibold'>
        ...
        <li> <Link  className='border-b border-b-red-600' href='/jewellery' >JEWELLERY</Link> </li>

        <li className=''> <Link href='/manscloths' >{`MEN'S CLOT`}H</Link> </li>
      ...
      <div className='p-1.5'>
        ...
        <div className='grid grid-cols-2 sm:grid-cols-3 sm:col-start-2 sm:col-span-1 border-gray-300 border-1 
        rounded-md place-items-center p-2 gap-2 mt-7 md:gap-y-5 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6'>

          {data.filter((products: dataProps) => products.category === 'jewelery').map((products: dataProps) => 
                    
            <div key={products.id} className=' text-black'>

              <div className='flex flex-col border-gray-300 border-1 rounded-md items-center justify-between 
              p-2 w-40 h-80 md:w-60 '>
                  ...
                  <div className='text-xs p-1 flex flex-col gap-y-2'>
                    ...
                    <div className='flex justify-end'>
                      ...
                      <button onClick={() => addBtn(products)} className='group border-red-400 border rounded-md 
                      cursor-pointer px-2 py-1 mb-3 flex items-center gap-x-2 
