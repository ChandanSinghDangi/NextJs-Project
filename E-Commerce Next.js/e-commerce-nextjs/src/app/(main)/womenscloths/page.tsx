  ...
  return (
    ...
    <>
        ...
        <ul className='flex gap-7 text-xs justify-center p-2 px-8 font-semibold'>
            ...
            <li className=''> <Link href='/manscloths' >{`MEN'S CLOTH`}</Link> </li>

            <li className='border-b border-b-red-600'> <Link href='/womenscloths' >{`WOMEN'S CLOTH`}</Link> </li>
        ...
        <div className='p-1.5'>
            ...
            {data.filter((products: dataProps) => products.category === "women's clothing").map((products: dataProps) => 
