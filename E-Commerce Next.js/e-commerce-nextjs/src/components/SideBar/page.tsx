...
//         <button style={cartBtnStyles} onClick={() => setIsOpen(true)}>🛒 Cart</button>
...
//               <button style={closeBtnStyles} onClick={() => setIsOpen(false)}>✖</button>
//             </div>

//             <div className='border-2 border-purple-400 p-2 rounded-md flex flex-col gap-y-3'>
//               {cartItems.map((product: dataProps) => (
